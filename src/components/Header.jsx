      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div className="flex gap-3">
          ...
          <select
            ...
            "
          >
            <option className="font-bold text-indigo-600" value="all">All Categories</option>

            {categories.map(c => (
              <option key={c} className="font-bold text-indigo-600 hover:bg-purple-200" value={c}>
                {c}
              </option>
            ))}
